...
public class LEAVE_LeaveListPage extends Base {
	...
	static By search_btn=By.xpath("//*[@id=\"Search\"]");
	
	
	
	
	
	 public static void leavelist(String frdate,String todate)throws Exception{
		 Thread.sleep(2000);
		 Actions ac=new Actions(driver);
			...
			Thread.sleep(3000);
			Reporter.log("Employee Leave List Displayed");
			Log.info("Employee Leave List Displayed");
	 }
